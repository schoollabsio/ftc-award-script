        ...
        <html>
            ...
            <body class="flex justify-center items-center h-screen bg-gray-100 sm:text-base">
                <div class="p-6 md:w-1/3 w-full md:h-auto h-full mx-auto bg-white rounded-xl shadow-md flex flex-col space-y-4">
                    ...
                    <select id="awards" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div class="flex flex-row justify-center">
                        <button id="submitButton" onclick="onSubmit()" class="bg-blue-500 text-white max-w-xs font-bold py-2 px-4 rounded hover:bg-blue-700">Generate</button>
